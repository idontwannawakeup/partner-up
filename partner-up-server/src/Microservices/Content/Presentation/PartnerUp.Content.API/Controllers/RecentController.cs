...
using PartnerUp.Content.Application.Features.Recent.Queries.GetRecentProjects;
using PartnerUp.Content.Application.Features.Recent.Queries.GetRecentTeams;
using PartnerUp.Content.Application.Features.Recent.Queries.GetRecentTickets;
using PartnerUp.Content.Domain.Enums;

namespace PartnerUp.Content.API.Controllers;
