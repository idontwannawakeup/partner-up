...
using PartnerUp.Identity.Persistence.Configuration;
using PartnerUp.Identity.Persistence.Operational;
using PartnerUp.Identity.Persistence.People;
using PartnerUp.Identity.Persistence.People.Data.Entities;

namespace PartnerUp.IdentityServer.Extensions.Dependencies;
