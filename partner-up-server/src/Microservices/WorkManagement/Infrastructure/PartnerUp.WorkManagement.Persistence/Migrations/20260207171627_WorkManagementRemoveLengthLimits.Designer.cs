...
namespace PartnerUp.WorkManagement.Persistence.Migrations
{
    ...
    [Migration("20260207171627_WorkManagementRemoveLengthLimits")]
    partial class WorkManagementRemoveLengthLimits
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PartnerUp.WorkManagement.Domain.Entities.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PartnerUp.WorkManagement.Domain.Entities.Team", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PartnerUp.WorkManagement.Domain.Entities.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PartnerUp.WorkManagement.Domain.Entities.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PartnerUp.WorkManagement.Domain.Entities.Project", b =>
                {
                    b.HasOne("PartnerUp.WorkManagement.Domain.Entities.Team", "Team")
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("PartnerUp.WorkManagement.Domain.Entities.Team", b =>
                {
                    b.HasOne("PartnerUp.WorkManagement.Domain.Entities.UserProfile", "Leader")
                        .WithMany()
            ...
            modelBuilder.Entity("PartnerUp.WorkManagement.Domain.Entities.Ticket", b =>
                {
                    b.HasOne("PartnerUp.WorkManagement.Domain.Entities.UserProfile", "Executor")
                        .WithMany("Tickets")
                        .HasForeignKey("ExecutorId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_Tickets_ExecutorId");

                    b.HasOne("PartnerUp.WorkManagement.Domain.Entities.Project", "Project")
                        .WithMany("Tickets")
            ...
            modelBuilder.Entity("TeamUserProfile", b =>
                {
                    b.HasOne("PartnerUp.WorkManagement.Domain.Entities.UserProfile", null)
                        .WithMany()
                        .HasForeignKey("MembersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PartnerUp.WorkManagement.Domain.Entities.Team", null)
                        .WithMany()
